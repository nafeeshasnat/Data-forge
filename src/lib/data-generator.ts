...
const SUBJECTS: Record<string, string[]> = {
  CSE: ["Introduction to Programming", "Data Structures", "Algorithms", "Database Systems", "Operating Systems", "Computer Networks", "Software Engineering", "Artificial Intelligence", "Machine Learning", "Web Programming", "Compiler Design", "Computer Graphics", "Cyber Security", "Discrete Mathematics", "Digital Logic Design", "Human-Computer Interaction", "Cloud Computing", "Big Data Analytics", "Cryptography", "Internet of Things", "Mobile Application Development", "Game Development", "Natural Language Processing", "Quantum Computing", "Advanced Algorithms", "Computer Vision", "Blockchain Technology", "Bioinformatics", "Robotics Process Automation", "Parallel Computing"],
  EEE: ["Basic Electrical Engineering", "Electronic Devices", "Digital Electronics", "Signals and Systems", "Control Systems", "Power Systems", "Electrical Machines", "Power Electronics", "Communication Engineering", "VLSI Design", "Microprocessors", "Embedded Systems", "Renewable Energy", "High Voltage Engineering", "Robotics", "Digital Signal Processing", "Optoelectronics", "Power System Protection", "Electric Drives", "Smart Grids", "Wireless Communication", "Satellite Communication", "Biomedical Instrumentation", "Fuzzy Logic and Neural Networks", "Advanced Control Systems", "Analog Integrated Circuits", "RF and Microwave Engineering", "Power Quality", "SCADA Systems", "Electrical and Electronic Measurement"],
  BBA: ["Principles of Management", "Principles of Accounting", "Financial Accounting", "Microeconomics", "Macroeconomics", "Business Statistics", "Marketing Principles", "Financial Management", "Human Resource Management", "Organizational Behavior", "Operations Management", "Business Law", "International Business", "Strategic Management", "E-Commerce", "Supply Chain Management", "Entrepreneurship Development", "Brand Management", "Consumer Behavior", "Investment Analysis", "Project Management", "Business Ethics", "Digital Marketing", "Risk Management", "Business Intelligence", "Sales Management", "Public Relations", "Corporate Finance", "Retail Management", "Logistics Management"],
};
